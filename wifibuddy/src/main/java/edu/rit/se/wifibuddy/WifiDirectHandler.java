...
public class WifiDirectHandler extends NonStopIntentService implements
    ...
    private boolean isConnectionSuccessfull = true;
...
//            localBroadcastManager.sendBroadcast(new Intent(Action.SERVICE_CONNECTED));
    ...
    public void cancelConnection() {
        wifiP2pManager.cancelConnect(channel, new WifiP2pManager.ActionListener() {
            @Override
            public void onSuccess() {
                Log.i(TAG,"Cancel connection successfully");
            }

            @Override
            public void onFailure(int reason) {
                Log.e(TAG,"Failed cancel connection: " + FailureReason.fromInteger(reason).toString());
            }
        });
    }
    ...
    public void initiateConnectToService(DnsSdService service) {
        ...
        wifiP2pManager.connect(channel, wifiP2pConfig, new WifiP2pManager.ActionListener() {
            ...
            public void onFailure(int reason) {
                ...
                //TODO:throw exception, implement events to know when it fails, implement connected status
    ...
    public void setConnectionSuccessfull(boolean connectionSuccessfull) {
        isConnectionSuccessfull = connectionSuccessfull;
    }
}
